...
SYNTAX = {
    ...
    # op_mw / op_mww currently do cpu.reg.read(dst) for the address --
    # register only. If you revert those to reg_or_imm(cpu, dst, imm)
    # (matching the old docstring's `MW [0xF000], A`), change the first
    # slot below to ("dst", "reg_or_imm").
