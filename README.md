...
user/os/bin/          the shell and its programs: sh, ls, cat, echo, mkdir, rmdir, rm, mv, cp, clear, more, edit, img, explorer, pgs
...
python3 tests/test_pgs.py         # pgs, the shell's scripts: variables, $( ), blocks
